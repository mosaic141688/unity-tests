...
const group_list_1 = require("../../../src/transforms/group_list");
ava_1.test('groupTransform()', t => {
    // Throws when options does not have 'expression'
    t.throws(() => {
        group_list_1.default('[{name: string}]', {});
    });
    // Throws when value type does not match input type
    t.throws(() => {
        group_list_1.default('number', { expression: { value: 1 } });
    });
    const section = group_list_1.default('[{name: string, age: number}]', {
        expression: {
            path: [
                { dep: '$element' },
                { value: 'age' }
...
//# sourceMappingURL=group_list_test.js.map